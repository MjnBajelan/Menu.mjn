...
let submenu1 = document.querySelector(
  "div.wrapper>div.menu>nav>ul>li:nth-of-type(1)>a"
);
let submenu2 = document.querySelector(
  "div.wrapper>div.menu>nav>ul>li:nth-of-type(2)>a"
);
let submenu3 = document.querySelector(
  "div.wrapper>div.menu>nav>ul>li:nth-of-type(3)>a"
);
...
// smenu
let icon = document.querySelector("div.wrapper>div.smenu>div.icon");

let submenu = document.querySelector(
  "div.wrapper>div.smenu>div.icon>div.s-menu"
);

let closeBtn = document.querySelector(
  "div.wrapper>div.smenu>div.icon>i.fa-times"
);

let menuBtn = document.querySelector(
  "div.wrapper>div.smenu>div.icon>i.fa-bars"
);
